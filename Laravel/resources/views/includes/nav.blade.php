...
<nav class="navbar navbar-expand-lg navbar-light">
  <a class="navbar-brand" href="/"><img src="{{ asset('/img/logo.png') }}" alt="" id="logo" width="150"></a>
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
  <div class="collapse navbar-right navbar-collapse navbar-dark navbar-d" id="navbarSupportedContent">
    <ul class="navbar-nav ">
      <li class="nav-item">
      ...
      <li class="nav-item">
      @if (auth()->user()->isAdmin())
        <a class="nav-link" href="/admin/projects">Backoffice</a>
        @endif
      </li>
      @endif
